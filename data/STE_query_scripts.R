...
pdf(file="STE_Int_Outcome_Heatmap_articles_4_24.pdf", width=11, height=8.5)
ggplot(io_counts, aes(x=Out_type,y=Int_type,fill=n)) +
  geom_tile(color="white",size=0.1) +
  geom_text(aes(label=n, color="white")) +
  scale_fill_viridis(name="# Cases",na.value="gray90") +
  coord_equal() +
...
pdf(file="STE_type_Int_Outcome_Heatmap_4_24.pdf", width=11, height=8.5)
gg
dev.off()
...
pdf(file="STE_Country_Map_dark_4_24.pdf", width=16, height=8.5)
ggplot() + 
...
dev.off()
############
#Circle packing to look at outcome subtypes within outcome domains
