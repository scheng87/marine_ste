...
load("~/Documents/github/marine_ste/data/STE_Evidence_Map_4_24_2018.RData")
...
map_data_final <- distinct(map_data_final)
map_data_final <- left_join(map_data_final,data.equity,by="aid")
map_data_final <- distinct(map_data_final)
...
saveRDS(map_data_final,file="data/map_data_final_4_24.rds")
